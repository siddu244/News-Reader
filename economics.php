    ...
    <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul id="navbar"  class="nav navbar-nav" style="margin-top: 5;">
               ...
               <li class="activeclass"><a href="economics.php">Economics</a></li>
...
<div id="side">
               <nav>
                        <ul style="margin-top: 155;font-size: 22;margin-left: -39;">
                              <li style="margin-top: 19;margin-bottom: 23;"><button class="button" class="button" class="button" class="button" type="button" onclick="loadXMLDoc('http://economictimes.indiatimes.com/rssfeedsdefault.cms','Economic')">HOME</button></li>
                              <li style="margin-bottom: 22;"><button type="button" class="button" class="button" class="button" onclick="loadXMLDoc('http://economictimes.indiatimes.com/Markets/markets/rssfeeds/1977021501.cms','MARKET')">MARKET</button></li>
                              <li style="margin-bottom: 22;"><button type="button" class="button" class="button" onclick="loadXMLDoc('http://economictimes.indiatimes.com/rssfeeds/2143429.cms','CNN')">COMPANY's</button></li>
                              <li><button type="button" class="button" onclick="loadXMLDoc('http://economictimes.indiatimes.com/rssfeeds/1373380680.cms','ECONOMY')">ECONOMY</button></li>
                        </ul>
             </nav>
...
">
  <ul>
      ...
      <div id="b_list">
        <h2 style="margin-bottom: 31;">Economics  --  Economic Times</h2><hr style="margin-top: -12px;margin-bottom: 20px;border: 0;border-top: 1px solid #292929;">
        <div id="b_l">
        <?php

        $s="";
        $content = file_get_contents('http://economictimes.indiatimes.com/rssfeedsdefault.cms');
        $x = new SimpleXmlElement($content);
        $i=0;
        foreach($x->channel->item as $entry) {
