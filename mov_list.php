    ...
    function loadXMLDoc(str,data)
    {
        ...
        xmlhttp.onreadystatechange=function()
          ...
          if (xmlhttp.readyState==4 && xmlhttp.status==200)
            {
            var rem=document.getElementById("b_list");
           // (rem.getElementsByTagName('h2')).innerHTML=data;
            document.getElementById("b_list").innerHTML=xmlhttp.responseText;
            }
          }
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul id="navbar"  class="nav navbar-nav" style="margin-top: 5;">
                ...
                <li class="activeclass"><a href="mov_list.php">Movies Reviews</a></li>
...
">
  <ul>
      ...
      <div id="b_list">
        <h2 style="margin-bottom: 31;">--  MOVIE REVIEWS  -- </h2><hr style="margin-top: -12px;margin-bottom: 20px;border: 0;border-top: 1px solid #292929;">
        <?php

        $s="";
      $content = file_get_contents('http://ibnlive.in.com/ibnrss/rss/reviews/reviews.xml');
      $x = new SimpleXmlElement($content);
      $i=0;
      foreach($x->channel->item as $entry) {
