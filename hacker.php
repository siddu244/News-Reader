    ...
    <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul id="navbar"  class="nav navbar-nav" style="margin-top: 5;">
                ...
                <li class="activeclass"><a href="hacker.php">Hacker</a></li>
...
">
  <ul>
      ...
      <div id="b_list">
        <h2 style="margin-bottom: 31;">HACKING  --  Hacker News</h2><hr style="margin-top: -12px;margin-bottom: 20px;border: 0;border-top: 1px solid #292929;">
        <?php

        $s="";
      $content = file_get_contents('https://news.ycombinator.com/rss');
      $x = new SimpleXmlElement($content);
      $i=0;
      foreach($x->channel->item as $entry) {
